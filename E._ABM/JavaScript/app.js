...
(function (Main) {
    ...
    function MostrarGrilla() {
        ...
        //ajax.Post("http://localhost:8080/clase04/abm_archivos_starter/administracion.php", MostrarGrillaSuccess, parametros, Fail);
    ...
    function EliminarProducto(codBarra) {
        ...
        //ajax.Post("http://localhost/clase04:8080/abm_archivos_starter/administracion.php", DeleteSuccess, parametros, Fail);
