...
namespace Main{
        ...
        export function MostrarGrilla():void {
            ...
            ajax.Post("http://localhost:8080/clase04/abm_archivos_starter/administracion.php", 
        ...
        export function EliminarProducto(codBarra:number):void {
            ...
            ajax.Post("http://localhost/clase04:8080/abm_archivos_starter/administracion.php", 
            DeleteSuccess, 
            parametros, 
            Fail);
